class_name ArrowGuideMapHandleGroup
extends GuideMapHandleGroup

onready var button_frames:Dictionary = {
	vertical = preload("res://Assets/Interface/Buttons/tres/arrows_vertical_button_sprite_frames.tres"),
	horizontal = preload("res://Assets/Interface/Buttons/tres/arrows_horizontal_button_sprite_frames.tres")
}
...
func _init(
	base_map_value:TileMap=null, 
	is_autotile_value:bool=false
