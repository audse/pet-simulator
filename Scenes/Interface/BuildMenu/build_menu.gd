...
func enter_state(next_state:int) -> void:
	match next_state:
		States.Build.EDITING:
			...
			($VBoxContainer/MarginContainer2/HBoxContainer as HBoxContainer).visible = false
			($VBoxContainer/MarginContainer2/EditingMenu as ButtonExpansionHBoxContainer).visible = true
			($VBoxContainer/MarginContainer2/EditingMenu as ButtonExpansionHBoxContainer).queue_sort()
...
func exit_state(next_state:int) -> void:
	match next_state:
		States.Build.EDITING:
			...
			($VBoxContainer/MarginContainer2/HBoxContainer as HBoxContainer).visible = true
			($VBoxContainer/MarginContainer2/EditingMenu as ButtonExpansionHBoxContainer).visible = false
